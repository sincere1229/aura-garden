    ...
    <section className="px-5 py-16 sm:px-8 sm:py-20">
      <div className="relative mx-auto max-w-3xl overflow-hidden rounded-[2rem] bg-gradient-to-br from-lavender-deep via-[#8a78b8] to-aqua-300 px-6 py-12 text-center text-white sm:px-12 sm:py-16">
        ...
        <div className="relative">
          ...
          <ul className="mx-auto mt-6 max-w-md space-y-2 text-left text-sm leading-relaxed text-white/90">
          ...
          <p className="mt-6 text-sm font-medium text-white/95">
            LINE登録で無料配布中
          </p>
          <Link
            href={SNS.line.url}
            ...
            className="mt-5 inline-flex items-center gap-2 rounded-full bg-white px-8 py-3.5 text-sm font-bold tracking-wide text-lavender-deep shadow-lg transition-transform hover:scale-[1.03]"
          >
